...
import Card from "@/components/LandingPages/Card";
...
export default function Example() {
  ...
  return (
    <div className="bg-gray-900" style={{
      backgroundImage: "url('/assets/images/light-green.png'), url('/assets/images/light-blue.png')",
      ...
      <div className="relative overflow-hidden">
          ...
          <div className=" pt-6 pb-4">
            ...
            >
              ...
              <div className="hidden md:flex md:items-center md:space-x-2 lg:space-x-12">
                ...
                <a
                  href="#"
                  className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-full text-white bg-[#3D00B7] hover:bg-[#3d00b7a1]"
                >
                  Sign in Account
                </a>
              </div>
        ...
        <main>
          <div
            className=" overflow-hidden sm:pt-12 lg:relative lg:py-36 xl:py-40"
            // style={{
            //   backgroundImage: "url('/assets/images/light-green.png'), url('/assets/images/light-blue.png')",
            //   // backgroundSize: "600px",
            //   // backgroundPosition: "center bottom",
          ...
          >
            ...
            <div className="sm:mx-auto sm:max-w-3xl sm:px-6">
              <div className="py-12 px-4 pl-4 sm:pl-0 sm:px-0 sm:relative sm:mt-12 sm:py-16 lg:absolute lg:inset-y-0 lg:right-20 lg:w-1/3">
                    ...
                    >
                      <div className="px-8 py-8 sm:px-6 rounded-3xl shadow-md bg-gray-800 relative">
                        ...
                        <div className="w-full mt-3 flex items-center justify-center absolute">
                          <div
                            style={{ padding: "1.3px" }}
                            className="bg-gradient-to-r from-[#73E0A9] to-[#5B68DF] rounded-full "
                          >
                            <img
                        ...
                        <div className="flex-col">
                          ...
                          <div className="mt-3">
                            <span className="text-white text-sm ">
                              ...
                              Ethereum blockchain. Your Zombie Lab Club NFT will
                              double as your club membership.
                            </span>
                          </div>
                        </div>
                      </div>
                ...
                <div className="relative pl-4 -mr-40 sm:mx-auto sm:max-w-3xl sm:px-0 lg:max-w-none lg:h-full lg:pl-2">
                  {/* <img
